...
class CreateProjectCollectionViewController: UIViewController, UINavigationControllerDelegate,
    UIImagePickerControllerDelegate, UIDocumentPickerDelegate, PHPickerViewControllerDelegate,
    Encodable, UITextFieldDelegate
{
    ...
    private func setupUI() {
        ...
        projectNameTextField.addTarget(
    ...
    private func updateVideoPreviewView() {
        ...
        if let videoURL = selectedVideoURL {
            ...
            let tapGesture = UITapGestureRecognizer(
                target: self, action: #selector(selectVideoButtonTapped))
    ...
    func updateTimesVisited(for projectName: String) {
        ...
        do {
            ...
            let updatedMetadataData = try PropertyListSerialization.data(
    ...
    private func saveProject() -> Bool {
        guard
            let projectName = projectNameTextField.text?.trimmingCharacters(
                in: .whitespacesAndNewlines), !projectName.isEmpty
        else {
            return false
        }
        ...
        do {
            ...
            try fileManager.createDirectory(
                at: projectDirectory, withIntermediateDirectories: true, attributes: nil)
            ...
            for subfolderName in subfolderNames {
                ...
                if subfolderName == "Original Videos" {
                    ...
                    let destinationURL = subfolderURL.appendingPathComponent(
            ...
            UserDefaults.standard.set(
                try? PropertyListEncoder().encode(projects), forKey: "projects")

            // Save additional metadata to a plist file
            let metadataURL = projectDirectory.appendingPathComponent("metadata.plist")
            let metadata: [String: Any] = [
                "timesVisited": project.timesVisited, "dateCreated": project.dateCreated,
            ]
...
extension CreateProjectCollectionViewController {
    ...
    @objc func textFieldDidChange(_ textField: UITextField) {
        ...
        createProjectButton.isEnabled =
            isProjectNameValid && selectedVideoURL != nil && !projectNameExists
